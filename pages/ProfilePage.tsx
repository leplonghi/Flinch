...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="space-y-10 py-6">
      ...
      {user?.isGuest && (
        <MotionDiv initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }}>
      ...
      <section className="grid grid-cols-2 gap-5 px-1">
        <MotionDiv initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.5 }}>
        ...
        <MotionDiv initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.6 }}>
          <Card className="text-center py-8 rounded-[2.5rem] bg-brand-surface/40 border-white/5">
      ...
      <MotionDiv initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.7 }}>
